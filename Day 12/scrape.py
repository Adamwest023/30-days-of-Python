...
# function to run and return html text if it is there
...
# parsing the data into a header and each movie in the table
...
# function declaring what url to grab from for parsing function
...
if __name__ == '__main__':
    # setting values to start and stop the scrape in years
    try:
